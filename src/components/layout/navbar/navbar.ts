import { Home, Newspaper, HeartPulse, Briefcase, User } from 'lucide-react';
...
export const getNavItems = (t: any, lang: string) => [
  ...
  { name: t('nav.works'), url: getLocalizedPath('/pekerjaan', lang), icon: Briefcase },
  { name: t('nav.services'), url: getLocalizedPath('/#layanan', lang), icon: HeartPulse },
];
