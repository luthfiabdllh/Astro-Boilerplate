...
export function NavBar({ items, className }: NavBarProps) {
    ...
    return (
        <div
            className={cn(
                "fixed bottom-0 lg:top-0 left-1/2 -translate-x-1/2 z-200 mb-6 lg:pt-6 h-max",
                className,
            )}
        >
            <div className="flex items-center gap-3 bg-background/5 border border-white/50 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg">
                {items.map((item) => {
